...
const Summary = () => {
  ...
  const premiumSummaryData = {
    weekHighlights: [
      "You've made significant progress in processing your recent breakup",
    ...
    nextSteps: [
      "Continue exploring your attachment patterns in the Rebuild mode",
      "Practice the self-compassion techniques we discussed",
      "Consider journaling about your childhood experiences",
      "Set boundaries with people who trigger your anxiety"
    ],
      ...
      <div className="min-h-screen gradient-bg">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-16">
            <div className="gradient-card p-12 rounded-lg border border-border/50 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8 text-left">
                  <div className="bg-secondary/50 p-6 rounded-lg border border-border/30">
                  ...
                  <div className="bg-secondary/50 p-6 rounded-lg border border-border/30">
                    <h3 className="font-semibold text-foreground mb-3">Therapist Notes</h3>
                    <p className="text-muted-foreground text-sm">
    ...
    <div className="min-h-screen gradient-bg">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-4 sm:mb-0">Therapy Summary</h1>
        ...
        {/* Week Highlights */}
        <div className="gradient-card p-6 rounded-lg border border-border/50 mb-8">
        ...
        <div className="gradient-card p-6 rounded-lg border border-border/50">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-foreground">Therapist Notes</h2>
          </div>
